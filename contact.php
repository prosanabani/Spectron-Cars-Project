...
<body>
   ...
   <div class="container-fluid bg-dark py-3 px-lg-5 d-none d-lg-block">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (isset($_POST["username"]) and isset($_POST["email"]) and isset($_POST["subject"]) and isset($_POST["message"])) {
            $sql = "INSERT INTO `contact` (`id` , `name`, `email`, `subject`, `message`)VALUES (NULL,'" . $_POST["username"] . "','" . $_POST["email"] . "','" . $_POST["subject"] . "','" . $_POST["message"] . "');";
                        ...
                        <form action="index.php" method="post">
                            <div class="row">
                                <div class="col-6 form-group">
                                    <input type="text" class="form-control p-4" placeholder="Your Name" name="username"
                                        required="required">
                                </div>
                                <div class="col-6 form-group">
                    ...
                    <div class="bg-secondary d-flex flex-column justify-content-center px-5 mb-4"
                        ...
                        <div class="d-flex mb-3">
                            ...
                            <div class="mt-n1">
                                ...
                                <p>14th October street , Sana'a , YEMEN</p>
                            </div>
                        </div>
                        <div class="d-flex mb-3">
                            <i class="fa fa-2x fa-map-marker-alt text-primary flex-shrink-0 mr-3"></i>
                        ...
                        <div class="d-flex">
                            ...
                            <div class="mt-n1">
                                ...
                                <p class="m-0">hospital@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
