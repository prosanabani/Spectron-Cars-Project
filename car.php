                    ...
                    <div class="rent-item mb-4">
                        ...
                        <div class="d-flex justify-content-center mb-4">
                            ...
                            <div class="px-2">
                                ...
                                <span><?php echo $row["milage"] ?>K</span>
                            </div>
                        </div>
                        <a class="btn btn-primary px-3" href="booking.php?id=<?php echo $row["id"] ?> ">Buy Now</a>
                    </div>
                </div>
                <?php
                }
                ...
                <div class="col-lg-6 px-0">
                    <div class="px-5 bg-secondary d-flex align-items-center justify-content-between"
                        ...
                        <div class="text-right">
                            ...
                            <p class="mb-4">Lorem justo sit sit ipsum eos lorem kasd, kasd labore
                            </p>
